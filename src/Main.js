          ...
          <div className="navigation">
            <div className="header-top">
              ...
              <div className="header-menu">
                ...
                <a onClick={(e) => toBlock(e.target.getAttribute('height'))} height="370">Технологический стек</a>
                <a onClick={(e) => toBlock(e.target.getAttribute('height'))} height="470">Портфолио</a>
              </div>
            </div>
